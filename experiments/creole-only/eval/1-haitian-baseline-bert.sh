...
#SBATCH --job-name=base-b-haitian
#SBATCH --output=baseline-bert-haitian.txt
#SBATCh --nodes=1
#SBATCH --ntasks=1
...
python eval_baseline.py --file_path=/science/image/nlp-datasets/creoles/data/eval/haitian/1600_medical_domain_sentences.ht \
 ...
 --tokenizer=bert-base-uncased --checkpoint_dir=/science/image/nlp-datasets/creoles/checkpoints/baselines/bert/haitian
